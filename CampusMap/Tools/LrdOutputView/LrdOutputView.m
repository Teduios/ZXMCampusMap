...
- (instancetype)initWithDataArray:(NSArray *)dataArray
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)]) {
        ...
        _tableView.separatorColor = [UIColor clearColor];//UIColor colorWithWhite:0.3 alpha:1
        _tableView.backgroundColor = [UIColor grayColor];//UIColor colorWithWhite:0.2 alpha:1
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.selectedBackgroundView.backgroundColor = [UIColor lightGrayColor];//blackColor
